...
useForm returns a tuple with the initial form object, an onchange handler, and whether or not the form is valid.

```
const [form, onChange, isValid] = useForm(initialState, formRef)
```
