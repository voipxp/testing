;(function() {
  angular.module('odin.user').component('userCallForwardingAlwaysSecondary', {
    templateUrl:
      'user/components/callForwardingAlwaysSecondary/userCallForwardingAlwaysSecondary.component.html',
  ...
  function Controller(
    ...
    function loadModule() {
      return Module.show('Call Forwarding Always Secondary').then(function(
        data
      ) {
        ctrl.module = data
      })
    ...
    function toggle() {
      ...
      ctrl.loading = true
      UserCallForwardingAlwaysSecondaryService.update(
        ctrl.userId,
        ctrl.settings
      )
        // .then(loadSettings)
