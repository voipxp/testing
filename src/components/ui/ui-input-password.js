...
export const UiInputPassword = ({ required = false, onGeneratePassword, ...props }) => {
      ...
      <Field kind="addons">
        <Control expanded iconRight>
          <Input
            ...
            autoCapitalize="off"
          />
          <Icon align="right" size="medium" color={passwordValid ? 'success' : 'light-grey'}>
            <FontAwesomeIcon icon={passwordValid ? faCheck : faExclamationTriangle} />
          </Icon>
        </Control>
        <Control>
      ...
      <Field kind="addons">
        <Control expanded iconRight>
          <Input
            ...
            autoCapitalize="off"
          />
          <Icon align="right" size="medium" color={repeatPasswordValid ? 'success' : 'light-grey'}>
            <FontAwesomeIcon icon={repeatPasswordValid ? faCheck : faExclamationTriangle} />
          </Icon>
        </Control>
        <Control>
