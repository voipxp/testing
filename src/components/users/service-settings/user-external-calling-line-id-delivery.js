...
import apiUserServiceCLIDExternalDelivery from '@/api/user-services-settings/user-external-calling-line-id-delivery-service'
import {
  UiCard,
  UiLoadingCard,
  UiButton,
...
export const UserCLIDExternalDelivery = ({ match }) => {
...
UserCLIDExternalDelivery.propTypes = {
