;(function() {
  angular.module('odin.group').component('groupFlexibleSeatingUsers', {
    templateUrl: 'group/components/flexibleSeating/users.component.html',
  ...
  function Controller($routeParams, Alert, GroupFlexibleSeatingHostService) {
    var ctrl = this
    ctrl.$onInit = onInit
    ...
    function update(userId, settings, callback) {
      Alert.spinner.open()
      GroupFlexibleSeatingHostService.update(userId, settings)
        .then(load)
        .then(function() {
    ...
    function bulk(data, callback) {
      Alert.spinner.open()
      GroupFlexibleSeatingHostService.bulk(data)
        .then(load)
        .then(function() {
