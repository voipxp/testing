;(function() {
  angular.module('odin.common').component('routingPoliciesFlexibleSeating', {
    templateUrl:
      'group/components/flexibleSeating/host/routingPolicies.component.html',
  ...
  function Controller(
    ...
    function edit() {
      activate().then(function() {
        ...
        Alert.modal.open('editRoutingPoliciesFlexibleSeating', function(close) {
    ...
    function sendUpdate(settings, callback) {
      ...
      GroupFlexibleSeatingHostRoutingPoliciesService.update(settings)
        .then(load)
        .then(function() {
