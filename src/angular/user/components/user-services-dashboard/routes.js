export default {
  ...
  'Automatic Hold/Retrieve': {
    component: 'userAutomaticHoldRetrieve',
  ...
  'Call Forwarding Selective': {
    component: 'userCallForwardingSelective',
  ...
  'Flexible Seating Guest': {
    component: 'userFlexibleSeatingGuest',
  ...
  'Meet-Me Conferencing': {
    component: 'userMeetMeConferencing',
