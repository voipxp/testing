...
angular.module('odin.group').component('groupOutgoingCallingPlanRedirecting', {
  template,
  controller,
  bindings: { serviceProviderId: '<', groupId: '<' }
})

controller.$inject = ['Alert', 'GroupOutgoingCallingPlanRedirectingService']
function controller(Alert, GroupOutgoingCallingPlanRedirectingService) {
  ...
  function edit(department) {
    ...
    Alert.modal.open('editGroupOutgoingCallingPlanRedirecting', function onSave(close) {
  ...
  function update(department, callback) {
    ...
    Alert.spinner.open()
    GroupOutgoingCallingPlanRedirectingService.update(ctrl.serviceProviderId, ctrl.groupId, plan)
      .then(loadPlan)
      .then(function() {
