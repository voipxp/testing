...
function controller(Alert, GroupVoiceMessagingService) {
  ...
  function loadSettings() {
    return GroupVoiceMessagingService.show(ctrl.serviceProviderId, ctrl.groupId).then(function(
      data
    ) {
      ctrl.settings = data
      return data
  ...
  function update(settings, callback) {
    Alert.spinner.open()
    GroupVoiceMessagingService.update(ctrl.serviceProviderId, ctrl.groupId, settings)
      .then(loadSettings)
      .then(function() {
