...
angular.module('odin.group').component('groupTrunkGroupUnreachableDestination', {
  template,
  controller,
...
function controller(Alert, GroupTrunkGroupService) {
  ...
  function loadAvailableTrunks() {
    return GroupTrunkGroupService.index(ctrl.parent.serviceProviderId, ctrl.parent.groupId, {
  ...
  function edit() {
    ...
    Alert.modal.open('editGroupTrunkGroupCallUnreachableDestination', function onSave(close) {
