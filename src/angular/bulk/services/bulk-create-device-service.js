...
angular.module('odin.bulk').factory('BulkCreateDeviceService', BulkCreateDeviceService)
...
function BulkCreateDeviceService() {
  ...
  function generate(device) {
    ...
    return {
      ...
      outboundProxyServerNetAddress: _.get(device, 'outboundProxyServerNetAddress', null),
      ...
      useCustomUserNamePassword: _.get(device, 'useCustomUserNamePassword', false),
