...
angular.module('odin.api').factory('UserOutlookIntegrationService', UserOutlookIntegrationService)
...
function UserOutlookIntegrationService($http, Route) {
  ...
  service.options = {
    contactRetrievalSelection: ['Retrieve Default Contact Folder Only', 'Retrieve All Contacts']
  }
