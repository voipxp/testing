...
angular
  .module('odin.api')
  .factory('UserOutgoingCallingPlanPinholeDigitPlanRedirectingService', Service)

Service.$inject = ['$http', 'Route']
function Service($http, Route) {
  var service = { show, update }
  service.options = { userPermissions: ['Ignore', 'Allow'] }
  var url = Route.api('/users/calling-plans/outgoing/pinhole-digit-plan/redirecting')
  return service
